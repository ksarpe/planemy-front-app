...
const sortedEvents = useMemo(() => 
  events.sort((a, b) => compareAsc(new Date(a.start), new Date(b.start)))
, [events]);
```
...
export default function Component({ ...props }: ComponentProps) {
  ...
  return (
    <div className="component-container bg-bg dark:bg-bg-dark">
...
- Examples: `@/data/types`, `@/hooks/useTheme`, `@/components/ui/Calendar`
