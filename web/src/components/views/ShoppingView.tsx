...
import { useShoppingItemsQuery } from "@shared/hooks/shopping/useShoppingItems";
...
export default function ShoppingView() {
  ...
  const getTabButtonClass = (tab: typeof activeTab) => {
    return `px-4 py-2 rounded-2xl font-medium transition-colors ${
    ...
    <div className="relative h-full p-4 flex flex-row overflow-auto scrollbar-hide">
      ...
      <div
        ...
        <div className="p-4 border-b border-bg-hover flex items-center gap-2 bg-bg-alt sticky top-0 z-10">
          ...
          <button
            onClick={() => setShowListsPanel(false)}
            className="inline px-2 rounded-2xl hover:text-negative cursor-pointer">
            <X size={22} />
          </button>
        </div>
      ...
      <div className="rounded-2xl flex-1 p-4 space-y-4 md:relative">
        {currentList ? (
          <>
            <ShoppingHeader
            ...
            <div className="flex flex-col-reverse md:flex-row gap-2">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                ...
                <button
                  ...
                  className="w-full md:w-auto flex items-center justify-center gap-2 bg-success text-white px-4 py-2 rounded-2xl hover:opacity-90 transition-opacity">
                  <Plus size={18} />
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <button
                ...
                className="bg-primary text-white px-4 py-2 rounded-2xl hover:opacity-90 transition-opacity">
