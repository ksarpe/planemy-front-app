    ...
    <div className={className}>
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "text-text text-sm p-4 pr-12 w-full rounded-2xl outline-0 border border-bg-muted-light hover:border-text-muted focus:border-primary focus:bg-primary/10 transition-colors",
          )}
          {...props}
        />
