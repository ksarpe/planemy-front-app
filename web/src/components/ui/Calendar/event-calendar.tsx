...
import { CalendarDndProvider } from "@/components/ui/Calendar/calendar-dnd-context";
import { AgendaDaysToShow, EventGap, EventHeight, WeekCellsHeight } from "@/components/ui/Calendar/constants";
import { EventPanel } from "@/components/ui/Calendar/events/event-panel";
import type { CalendarEvent, CalendarView } from "@/components/ui/Calendar/types";
import { addHoursToDate } from "@/components/ui/Calendar/utils";
import { AgendaView } from "@/components/ui/Calendar/views/agenda-view";
import { DayView } from "@/components/ui/Calendar/views/day-view";
import { MonthView } from "@/components/ui/Calendar/views/month-view";
import { WeekView } from "@/components/ui/Calendar/views/week-view";
  ...
  return (
    <div
      ...
      <CalendarDndProvider onEventUpdate={handleEventUpdate}>
        <div className={cn("flex items-center justify-between p-2 sm:p-4 bg-bg-primary text-text", className)}>
          {/* LEFT SIDE */}
          <div className="flex items-center gap-1 sm:gap-2">
            <div id="calendar-navigation" className="flex items-center sm:gap-2">
              ...
              <Button variant="default" size="icon" onClick={handleToday}>
                Today
              </Button>
        ...
        <div className="flex flex-1 min-h-0 flex-col pl-2">
          {view === "month" && (
            <MonthView
