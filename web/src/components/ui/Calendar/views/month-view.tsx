...
import { DefaultStartHour, EventGap, EventHeight } from "@/components/ui/Calendar/constants";
...
import { useEventVisibility } from "@/components/ui/Calendar/utils/use-event-visibility";
...
export function MonthView({ currentDate, events, onEventSelect, onEventCreate, onEventDelete }: MonthViewProps) {
  ...
  return (
    ...
    <div
      ...
      className="flex flex-col flex-1 rounded-tl-2xl bg-bg-primary shadow-[-2px_-2px_6px] border border-bg-muted-light shadow-bg-muted-light overflow-auto">
