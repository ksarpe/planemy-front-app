    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="w-80 bg-bg-primary rounded-xl shadow-2xl border border-bg-muted-light overflow-hidden cursor-pointer">
          ...
          {/* Actions footer */}
          <div className="p-2 bg-bg-primary border-t border-bg-secondary flex items-center gap-2">
            {onDeleteRequest && (
              <Button
                onClick={(e) => {
                  e.stopPropagation();
