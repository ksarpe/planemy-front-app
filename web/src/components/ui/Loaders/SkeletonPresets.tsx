...
export function SkeletonCalendarEvent() {
  return (
    <div className="border border-border rounded-2xl p-3 space-y-2 bg-bg-primary">
...
export function SkeletonLabelCard() {
  return (
    <div className="border border-border rounded-2xl p-4 bg-bg-primary">
...
export function SkeletonPaymentCard() {
  return (
    <div className="border border-border rounded-2xl p-4 bg-bg-primary space-y-3">
      <div className="flex items-center justify-between">
...
export function SkeletonProfileHeader() {
  return (
    <div className="flex items-center space-x-4 p-6 bg-bg-primary rounded-2xl">
