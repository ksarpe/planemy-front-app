...
export const PreferencesStep = ({ onboardingData, updateOnboardingData }: OnboardingStepBaseProps) => {
  //const { t } = useT();
  const [language, setLanguage] = useState(onboardingData.language || "pl-PL");
  ...
  const languages = [
    { code: "pl-PL", name: "Polski", countryCode: "PL" },
    { code: "en-US", name: "Angielski", countryCode: "GB" },
  ];
            ...
            <button
              ...
              className={`p-4 rounded-2xl border-2 transition-all ${
                language === lang.code
                  ...
                  : "border-gray-200  bg-bg-primary  hover:border-primary/50 text-text"
              }`}>
