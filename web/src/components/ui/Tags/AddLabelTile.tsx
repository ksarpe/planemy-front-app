...
export default function AddLabelTile({ onClick, loading }: AddLabelTileProps) {
  ...
  return (
    <button
      onClick={onClick}
      disabled={loading}
      className="bg-white  rounded-lg p-4 shadow-md border-2 border-dashed border-gray-300 cursor-pointer  hover:border-primary hover:shadow-md transition-all duration-200 disabled:opacity-50 group">
