...
export default function LabelCard({ label, onEdit }: LabelCardProps) {
  const colorHex = getColorHex(label.color as ColorName);
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div
            ...
            className="w-10 h-10 rounded-xl border-2 flex items-center justify-center group-hover:scale-110 transition-transform">
