...
export default function BuddyWidget() {
  ...
  // Placeholder data - replace with real data from context/API
  const buddyData = {
    level: 5,
    currentXP: 1250,
    nextLevelXP: 2000,
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-text">Level {buddyData.level}</span>
              <span className="text-xs text-text-muted">
                {buddyData.currentXP} / {buddyData.nextLevelXP} XP
              </span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="text-lg">🔥</span>
              <span className="text-sm font-semibold text-text">{buddyData.streak} dni</span>
            </div>
          </div>

          {/* Progress Bar */}
          <div className="w-full bg-bg-muted-light rounded-full h-6 overflow-hidden relative">
            <div
