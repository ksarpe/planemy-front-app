          ...
          <div className="grid grid-cols-8">
            ...
            <div className="border-r border-gray-200 dark:border-gray-700">
              {timeSlots.map((slot) => (
                <div
                  key={slot.hour}
                  className="h-15 border-b border-gray-100 dark:border-gray-800 px-2 py-1"
                  style={{ height: "60px" }}>
              ...
              return (
                <div
                  ...
                  {timeSlots.map((slot) => (
                    <div
                      key={slot.hour}
                      className="h-15 border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                      style={{ height: "60px" }}
                    />
                  ))}

                  {/* All-day events */}
                  <div className="absolute top-0 left-0 right-0 z-10 p-1 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                    {dayEvents
