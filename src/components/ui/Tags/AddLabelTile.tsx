...
export default function AddLabelTile({ onClick, loading }: AddLabelTileProps) {
  return (
    <button
      onClick={onClick}
      disabled={loading}
      className="bg-white dark:bg-bg-hover-dark rounded-md p-4 shadow-sm border-2 border-dashed border-gray-300 cursor-pointer dark:border-gray-600 hover:border-primary hover:shadow-md transition-all duration-200 disabled:opacity-50 group">
