...
import type { EmptyLabelsStateProps } from "@/data/Utils/UI/ComponentInterfaces";

export default function EmptyLabelsState({ onCreateFirst }: EmptyLabelsStateProps) {
  return (
    <div className="text-center py-12">
      <Tag size={48} className="mx-auto text-gray-400 mb-4" />
      <h3 className="text-lg font-medium text-gray-600  mb-2">Brak etykiet</h3>
      <p className="text-gray-500  mb-4">Rozpocznij organizację swoich zadań tworząc pierwszą etykietę</p>
      <button
