        ...
        <div className="p-6 space-y-6">
          {shareSuccess ? (
            ...
            <>
              {/* Search User */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Adres email użytkownika</label>
              ...
              {searchResults.length > 0 && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Wybierz użytkownika</label>
              ...
              {selectedUser && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Poziom uprawnień</label>
                  <div className="space-y-2">
