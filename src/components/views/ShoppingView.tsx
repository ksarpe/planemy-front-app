...
export default function ShoppingView() {
  ...
  const totalValue = currentList?.items.reduce((sum, item) => 
  ...
  return (
    <div className="flex h-full p-4 gap-4">
      ...
      <div className="w-80 bg-bg-alt dark:bg-bg-dark rounded-3xl shadow-md overflow-hidden">
        {/* Tab Headers */}
        <div className="p-4 border-b border-gray-200 dark:border-gray-600">
          <div className="flex gap-2">
            <button
              onClick={() => setActiveTab('shopping')}
              className={getTabButtonClass('shopping')}
            >
      ...
      {/* Main Content */}
      <div className="flex-1 bg-bg-alt dark:bg-bg-dark rounded-3xl shadow-md overflow-auto">
        {currentList ? (
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-sm text-gray-500">
                  {filteredItems.length} produktów
                </span>
              </div>
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-4">
                Wybierz listę z panelu bocznego lub utwórz nową
              </p>
              <button
